...
List<Specialist> FiltringSpecialists = [specialist1, specialist2, specialist3, specialist4];
            ...
            body: Container(
                ...
                child: Column(children: <Widget>[
                  TextField(
                    ...
                    onChanged: (string) {
                      setState(() {
                        FiltringSpecialists = (specialists.where((element) =>
                  ...
                  Expanded(
                    // here we add the snapshot from database
                      child: ListView.builder(
                          ...
                          itemCount: FiltringSpecialists.length,
                          itemBuilder: (BuildContext context, int index) {
                            return Card(
                                borderOnForeground: true,
                                child: ListTile(
                                  title: Text(FiltringSpecialists[index].name,
