                                ...
                                child: StreamBuilder(
                                    ...
                                    builder: (context,
                                      ...
                                      return DropdownButton<String>(
                                        value: teacherName,
                                        isDense: true,
                                        hint: Text(document.data()['teacherName']),
                                        onChanged: (newValue) {
                                          setState(() {
                              ...
                              new Padding(
                                ...
                                child: StreamBuilder(
                                    ...
                                    builder: (context,
                                      ...
                                      return DropdownButton<String>(
                                        value: psychologySpecialistName,
                                        isDense: true,
                                        hint: Text(document.data()['psychologySpecialistName']!=null ?document.data()['psychologySpecialistName']:"لا يوجد" ),
                                        onChanged: (newValue) {
                                          setState(() {
                                            psychologySpecialistName= newValue;
                                          });
                                          print(psychologySpecialistName);
                                        },
                                        items: snapshot.data.docs
                                          ...
                                          return new DropdownMenuItem<String>(
                                              value:  document
                                                  .data()["name"],
                                              onTap: () {
                                                psychologySpecialistId = document
                                                    .data()["uid"];
                              ...
                              new Padding(
                                ...
                                child: StreamBuilder(
                                    ...
                                    builder: (context,
                                      ...
                                      return DropdownButton<String>(
                                        value: occupationalSpecialistName,
                                        isDense: true,
                                        hint: Text(document.data()['occupationalSpecialistName']!=null ?document.data()['occupationalSpecialistName']:"لا يوجد"),
                                        onChanged: (newValue) {
                                          setState(() {
                                            occupationalSpecialistName = newValue;
                                          });
                                        ...
                                        items: snapshot.data.docs
                                          ...
                                          return new DropdownMenuItem<String>(
                                              value:  document
                                                  .data()["name"],
                                              onTap: () {
                                                occupationalSpecialistId = document
                                                    .data()["uid"];
                                ...
                                child: StreamBuilder(
                                    ...
                                    builder: (context,
                                      ...
                                      return DropdownButton<String>(
                                        ...
                                        isDense: true,
                                        hint: Text(document.data()['physiotherapySpecialistName']!=null?document.data()['physiotherapySpecialistName']:"لا يوجد" ),
                                        onChanged: (newValue) {
                                          setState(() {
                                            physiotherapySpecialistName = newValue;
                                          });
                                          print(physiotherapySpecialistName);
                                        },
                                        items: snapshot.data.docs
                                            .map((DocumentSnapshot document) {
                                          ...
                                          return new DropdownMenuItem<String>(
                                              value:  document
                                                  .data()["name"],
                                              onTap: () {
                                                physiotherapySpecialistId = document
                                                    .data()["uid"];
                                                print(physiotherapySpecialistId);
                                              },
                                              child: new Container(
                                ...
                                child: StreamBuilder(
                                    ...
                                    builder: (context,
                                      ...
                                      return DropdownButton<String>(
                                        ...
                                        isDense: true,
                                        hint: Text(document.data()['communicationSpecialistName']!= null ?document.data()['communicationSpecialistName']:"لا يوجد"),
                                        onChanged: (newValue) {
                                          setState(() {
                                            communicationSpecialistName = newValue;
                                          });
                                        ...
                                        items: snapshot.data.docs
                                          ...
                                          return new DropdownMenuItem<String>(
                                              value:  document
                                                  .data()["name"],
                                              onTap: () {
                                                communicationSpecialistId = document
                                                    .data()["uid"];
                                ...
                                onPressed:() {
                                  ...
                                  if (teacherId!=null)  {
                                   Admin_Teachers.get().then((value) => value.docs.forEach((element) {
                                      Admin_Teachers.doc(element.id).collection('Students').doc(uid).delete().whenComplete(() {
                                          Admin_Teachers.doc(teacherId).collection('Students').doc(uid).set({
                                                 'uid':uid
                                                            });});}));

                                      Teachers.get().then((value) => value.docs.forEach((element) {
                                        Teachers.doc(element.id).collection('Students').doc(uid).delete().whenComplete(() {
                                                Teachers.doc(teacherId).collection('Students').doc(uid).set({
                                                     'uid':uid
                                                                                   });});  }));}
                                    ...
                                    if (psychologySpecialistId!=null){
                                   Admin_Specialists.where('typeOfSpechalist',isEqualTo:"أخصائي نفسي").get().then((value) => value.docs.forEach((element) {
                                    Admin_Specialists.doc(element.id).collection('Students').doc(uid).delete().whenComplete((){
                                           Admin_Specialists.doc(psychologySpecialistId).collection('Students').doc(uid).set({
                                                            'uid':uid
                                    });});  }));



                                        Specialists.where('typeOfSpechalist',isEqualTo:"أخصائي نفسي").get().then((value) => value.docs.forEach((element) {
                                       Specialists.doc(element.id).collection('Students').doc(uid).delete().whenComplete((){

                                               Specialists.doc(psychologySpecialistId).collection('Students').doc(uid).set({
                                                   'uid':uid
                                               });});  }));}

              if (communicationSpecialistId!=null){
              Admin_Specialists.where('typeOfSpechalist',isEqualTo:"أخصائي تخاطب" ).get().then((value) => value.docs.forEach((element) {
              Admin_Specialists.doc(element.id).collection('Students').doc(uid).delete().whenComplete((){
              Admin_Specialists.doc(communicationSpecialistId).collection('Students').doc(uid).set({
              'uid':uid  });});  }));


              Specialists.where('typeOfSpechalist',isEqualTo:"أخصائي تخاطب" ).get().then((value) => value.docs.forEach((element) {
              Specialists.doc(element.id).collection('Students').doc(uid).delete().whenComplete(() {
              Specialists.doc(communicationSpecialistId).collection('Students').doc(uid).set({
              'uid':uid  });});  }));}


              if (occupationalSpecialistId!=null){
              Admin_Specialists.where('typeOfSpechalist',isEqualTo:"أخصائي علاج وظيفي").get().then((value) => value.docs.forEach((element) {
              Admin_Specialists.doc(element.id).collection('Students').doc(uid).delete().whenComplete((){

              Admin_Specialists.doc(occupationalSpecialistId).collection('Students').doc(uid).set({
              'uid':uid });});  }));
              Specialists.where('typeOfSpechalist',isEqualTo:"أخصائي علاج وظيفي").get().then((value) => value.docs.forEach((element) {
              Specialists.doc(element.id).collection('Students').doc(uid).delete().whenComplete(() {

              Specialists.doc(occupationalSpecialistId).collection('Students').doc(uid).set({
              'uid':uid});});  }));}


              if (physiotherapySpecialistId!=null){
              Admin_Specialists.where('typeOfSpechalist',isEqualTo:"أخصائي علاج طبيعي" ).get().then((value) => value.docs.forEach((element) {
              Admin_Specialists.doc(element.id).collection('Students').doc(uid).delete().whenComplete(() {

              Admin_Specialists.doc(physiotherapySpecialistId).collection('Students').doc(uid).set({
              'uid':uid
              });});  }));

              Specialists.where('typeOfSpechalist',isEqualTo:"أخصائي علاج طبيعي" ).get().then((value) => value.docs.forEach((element) {
              Specialists.doc(element.id).collection('Students').doc(uid).delete().whenComplete(() {

              Specialists.doc(physiotherapySpecialistId).collection('Students').doc(uid).set({
              'uid':uid  });});  }));}
