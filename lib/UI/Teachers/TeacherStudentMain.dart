...
class TeacherStudentMain extends StatefulWidget {
  ...
  @override
  TeacherStudentMain({
    this.index,this.centerId,this.name,this.uid,this.teacherName,this.teacherId,
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> _screens=[
      DiariesTeacher(
          ...
          teacherId:widget.teacherName),
      AppointmentsTeacher(widget.uid),
      PlansTeacherFirstPage(widget.uid),
      StudyCaseScreen(studentId: widget.uid,centerId: widget.centerId,
