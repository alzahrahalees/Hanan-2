...
class _SpecialMajorsPageState extends State<SpecialMajorsPage>
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference studentsPlansGoal = FirebaseFirestore.instance
        ...
        .doc(widget.planId)
        .collection("Goals");
    CollectionReference teachersPlansGoal = FirebaseFirestore.instance
        .collection('Teachers')
        .doc(_userTeacher.email)
        .collection('Students')
        .doc(widget.studentId)
        .collection('Plans')
        .doc(widget.planId)
    ...
    return SafeArea(
      child: Scaffold(
          ...
          body: TabBarView(
            ...
            children: [
              MajorStreamBuilder(
                studentsPlansGoal: studentsPlansGoal,
              ...
              MajorStreamBuilder(
                  studentsPlansGoal: studentsPlansGoal,
                  widget: widget,
                  major: 'المجال الإدراكي'),
              //4
              MajorStreamBuilder(
                  studentsPlansGoal: studentsPlansGoal,
                  widget: widget,
                  major: 'المجال الحركي الدقيق'),
              //5
              MajorStreamBuilder(
                  studentsPlansGoal: studentsPlansGoal,
                  widget: widget,
                  major: 'المجال الاجتماعي'),
              //6
              MajorStreamBuilder(
                  studentsPlansGoal: studentsPlansGoal,
                  widget: widget,
                  major: 'المجال الاستقلالي'),
            ],
          )),
    );
  }
...
class MajorStreamBuilder extends StatelessWidget {
  const MajorStreamBuilder(
    ...
    return SafeArea(
        child: StreamBuilder<QuerySnapshot>(
            stream: studentsPlansGoal
                .where('goalType', isEqualTo: major)
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => GoalAnalysisMain(
                                            goalType: major,
                                            studentId: widget.studentId,
                                            planId: widget.planId,
                              ...
                              child: Column(
                                children: [
                                  ListTile(
                                    title: Center(
                                      child:
                                          Text(documentSnapshot['goalTitle']),
                                    ),
                                    leading: Icon(
                                      Icons.title,
                                  ...
                                  ListTile(
                                    title: Text(documentSnapshot['generalGoal'],
                                        style: TextStyle(
