    ...
    return SafeArea(
      child: Scaffold(
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: (){
            Navigator.push(context,MaterialPageRoute(builder: (context) =>AddGoal(studentId: widget.studentId,planId: widget.planId,)));
          },
        ),
        appBar: AppBar(
      ...
      child:ListView.builder(
          ...
          itemBuilder:(context,index){
            ...
            return Column(
              ...
              GestureDetector(
                onTap:(){
                  Navigator.push(context,MaterialPageRoute(builder: (context) =>GoalAnalysisMain(studentId: widget.studentId,planId: widget.planId,goalId: documentSnapshot["goalId"],)));
                },
                child: Card(
            ...
            studentsPlansGoal.doc(documentSnapshot['goalId']).collection('ProceduralGoals').get().then((value) =>
            value.docs.forEach((element) { studentsPlansGoal.doc(documentSnapshot['goalId']).collection('ProceduralGoals').doc(element.id).delete();}));
            studentsPlansGoal.doc(documentSnapshot['goalId']).collection('Notes').get().then((value) =>
            value.docs.forEach((element) { studentsPlansGoal.doc(documentSnapshot['goalId']).collection('Notes').doc(element.id).delete();}));
            studentsPlansGoal.doc(documentSnapshot['goalId']).collection('Evaluation').get().then((value) =>
            value.docs.forEach((element) { studentsPlansGoal.doc(documentSnapshot['goalId']).collection('Evaluation').doc(element.id).delete();}));
            ...
            specialists.get().then((value) => value.docs.forEach((element) {  specialists.doc(element.id).collection('Students').doc(widget.studentId).collection('Plans').doc(documentSnapshot['planId']).collection('Goals').doc(documentSnapshot['goalId']).collection('ProceduralGoals').get().then((value) =>
            value.docs.forEach((element2) {specialists.doc(element.id).collection('Students').doc(widget.studentId).collection('Plans').doc(documentSnapshot['planId']).collection('Goals').doc(documentSnapshot['goalId']).collection('ProceduralGoals').doc(element2.id).delete();}));}));
