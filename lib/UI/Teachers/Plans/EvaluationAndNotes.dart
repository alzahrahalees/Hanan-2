...
class NotesAndEvaluation extends StatefulWidget {
  ...
  final String goalId;
  final String type;
  NotesAndEvaluation ({this.studentId,this.planId,this.goalId, this.type});
...
class _NotesAndEvaluationState extends State<NotesAndEvaluation> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<String> _getName() async{
      ...
      await FirebaseFirestore.instance.collection('Users')
          .doc(_currentUser).get().then((value) {
    ...
    Future<String> _getStudentName() async{
      ...
      await FirebaseFirestore.instance.collection('Students')
          .doc(widget.studentId).get().then((value) {
        name = value.data()['name'];
    ...
    Future<String> getGoalName()async{
      ...
      await FirebaseFirestore.instance.collection('Students')
          ...
          .doc(widget.goalId).get().then((value) => aName = value.data()['goalTitle']);

      return aName;
    }

    CollectionReference studentGoalEval = FirebaseFirestore.instance.collection('Students')
        .doc(widget.studentId).collection('Plans')
        .doc(widget.planId).collection("Goals")
              ...
              builder: ( context,  snapshot) {
                ...
                return Column(
                 ...
                 children: snapshot.data.docs.map<Widget>((DocumentSnapshot doc){
                   ...
                   if( doc.data().isEmpty && widget.type == 'Teachers' ){
                   ...
                   else if ( doc.data().isEmpty && widget.type != 'Teachers'){
                     return Text(
                         "لم يتم إضافة تقييم نهائي للطالب ",
                         style: kTextPageStyle.copyWith(
                             fontSize: 18));
                   }
                   else {
                     String isDone = doc.data()['isDone'];
                     ...
                     String monthOfPub = doc.data()['monthOfPublish'].toString();
                     ...
                     return Padding(
                       ...
                       Container(
                         ...
                         children: [
                           ...
                           Padding(
                             padding: const EdgeInsets.all(4),
                             child: Text(helpType==null? 'لا يوجد': helpType),
                           ),
                         ],
                       ),
                         ),
                                 ...
                                 children: [
                                   ...
                                   SizedBox(
                                     ...
                                     child: Padding(
                                       padding: const EdgeInsets.all(8.0),
                                       child: TextFormField(
                                         initialValue: note==null? 'لا يوجد' : note,
                                         readOnly: true,
                                         minLines: 2,
                                         maxLines: 10,
                                       ),
                                   ...
                                   Padding(
                                     padding: const EdgeInsets.only(right:30, top: 8.0, bottom: 8.0),
                                     child: Row(
                                       children: [
                                         Text('تاريخ التقييم: ',
                                           style: TextStyle(color: Colors.black38),),
                                         Text('$yearOfPub / $monthOfPub / $dayOfPub',
                                           style: TextStyle(color: Colors.black38),),
                                       ],
                                     ),
                                   ),
                    ...
                    builder:( context,  snapshot) {
                      ...
                      physics: ScrollPhysics(),
                        ...
                        DocumentSnapshot document =snapshot.data.docs[index];
                          ...
                          String year =  document.data()['yearOfPublish'].toString();
                          String month= document.data()['monthOfPublish'].toString();
                          String day = document.data()['dayOfPublish'].toString();
                          String nameOfPublisher = document.data()['nameOfPublisher'];
                          ...
                          return Card(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ListTile(
                                  title:  Text(theNote, style: TextStyle(fontSize: 15),),
                                  trailing:  IconButton(
                                        ...
                                        return Alert(
                                          ...
                                          buttons: [
                                            ...
                                            DialogButton(
                                              ...
                                              onPressed: ()
                                              { studentNotes.doc(document.id).delete();
  ...
  const AddEvaluation({ this.studentId, this.planId, this.goalId, this.studentName, this.goalName, this.collectionPath});
    ...
    Widget build(BuildContext context) {
      return Scaffold(
        appBar: AppBar(
          ...
          title: Text('إضافة التقييم النهائي للهدف',
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(blurRadius: 5,
                          color: Colors.grey,
                          offset: Offset(1, 3))] // make rounded corner of border
                                         ),
                child: Column(
                  children: [
                    Padding(
            ...
            Padding(
              ...
              child: RaisedButton(
                ...
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(18.0)),
                onPressed: ()  {
                  widget.collectionPath.doc('eval').set({
                    'goalName': widget.goalName,
                    'studentName': widget.studentName,
                    'isDone': _achievementValue,
                    ...
                    'dayOfPublish':DateTime.now().day,
                      ...
                      .catchError((e)=> print('inside on press of eval err: $e'));
                  Navigator.pop(context);
                },
              ),
            )
