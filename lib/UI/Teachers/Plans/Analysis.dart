    ...
    snapshot.data.docs.map((DocumentSnapshot document) {
      ...
      children:[
            ...
            StreamBuilder<QuerySnapshot>(
              stream: teachersPlansGoal.doc(widget.goalId).collection('ProceduralGoals').orderBy('createdAt',descending: true).snapshots(),
             ...
             if (snapshot.hasData){
                return ListView(
                  ...
                  children: [
                    ...
                    Center(child: Text("الأهداف الإجرائية الخاصة بالمعلم",style: kTextPageStyle)),
                    ListView.builder(
                        itemCount: snapshot.data.docs.length,
                        shrinkWrap: true,
                        physics: ScrollPhysics(),
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        canEdit ==true?
                                            FlatButton(onPressed: (){
                                            setState(() {
                                              teachersPlansGoal.doc(widget.goalId).collection("ProceduralGoals").doc(documentSnapshot2['proceduralGoalId']).update({
