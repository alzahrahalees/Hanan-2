...
import 'package:hanan/UI/Teachers/Diaries/readPostNotification.dart';
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => OnePostNot(
                                            postId: document.data()['postId'],
                                            notificationId: document
                                                .data()['NotificationUid'],
                                            centerId:
                                                document.data()['centerId'],
                                            studentId: document.data()['uid'],
                                            teacherName: document.data()[''],
                                          )),
                                );
