...
class SpecialistStudentMain extends StatefulWidget {
  ...
  SpecialistStudentMain(
      ...
      this.teacherName,
      this.teacherId,
      this.communicationSpecialistId,
      this.communicationSpecialistName,
      this.physiotherapySpecialistId,
      this.physiotherapySpecialistName,
      this.psychologySpecialistId,
      this.psychologySpecialistName,
      this.occupationalSpecialistId,
      this.occupationalSpecialistName});
  @override
...
class _SpecialistStudentMainState extends State<SpecialistStudentMain> {
  ...
  Widget build(context) {
    ...
    List<Widget> _screens = [
      AppointmentsSpecialist(studentId: widget.uid),
      SpecialistPlans(widget.uid),
      SpechalistStudyCaseScreen(
...
//          unselectedIconTheme: IconThemeData(size: 25),
          ...
          body: CustomScrollView(slivers: <Widget>[
            SliverAppBar(
              ...
              title: Text('${_titles[_currentIndex]} ${widget.name}',
